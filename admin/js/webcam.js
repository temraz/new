...
/* Usage:
	<script language="JavaScript">
		...
		webcam.set_api_url( 'http://tzd-themes.com/hagal_admin/js/lib/webcam/test.php' );
...
window.webcam = {
	version: 'http://tzd-themes.com/hagal_admin/js/lib/webcam/1.0.11',	
	// globals
	ie: !!navigator.userAgent.match(/MSIE/),
	protocol: location.protocol.match(/https/i) ? 'https' : 'http',
	callback: null, // user callback for completed uploads
	swf_url: 'webcam-1.swf'/*tpa=http://tzd-themes.com/hagal_admin/js/lib/webcam/webcam.swf*/, // URI to webcam.swf movie (defaults to cwd)
	shutter_url: 'shutter-1.mp3'/*tpa=http://tzd-themes.com/hagal_admin/js/lib/webcam/shutter.mp3*/, // URI to shutter.mp3 sound
	...
	set_shutter_sound: function(enabled, url) {
		...
		if(!set_shutter) {
			this.shutter_url = url ? url : 'shutter-1.mp3'/*tpa=http://tzd-themes.com/hagal_admin/js/lib/webcam/shutter.mp3*/;
		}
	},
