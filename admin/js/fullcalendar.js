...
function disableTextSelection(element) {
	element
		...
		.bind('http://tzd-themes.com/hagal_admin/js/lib/fullcalendar/selectstart.ui', function() { return false; });
}
...
function enableTextSelection(element) {
	element
		...
		.css('MozUserSelect', '')
		.unbind('http://tzd-themes.com/hagal_admin/js/lib/fullcalendar/selectstart.ui');
}
*/
